...
打开 [Releases](https://github.com/SiriZhao/recallforge-skill/releases/latest)，下载 `recallforge-skill-v2.0.0.zip` 并解压到自己找得到的位置。RecallForge 是 Python 命令行 Skill，需要 Python 3.10 或更高版本。
