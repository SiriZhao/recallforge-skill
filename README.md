...
|---|---|---|
| A student or regular Codex user | `recallforge-skill-v2.1.3.zip` | User-level Skill folder |
...
| A Plugin user | `recallforge-plugin-v2.1.3.zip` | Host Plugin flow |

### User installation (recommended)

Extract `recallforge-skill-v2.1.3.zip`. It contains one folder: `recallforge`. Copy that folder to your user Skills directory:
